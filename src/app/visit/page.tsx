    ...
    <div className="pb-5">
      <section className="container-shell grid gap-3 py-3 lg:grid-cols-[1.08fr_.92fr] lg:py-5">
        ...
        <div className="flex flex-col justify-between rounded-[30px] bg-persimmon p-5 sm:p-8 lg:p-10">
          ...
          <div className="py-16"><h1 className="display text-[clamp(3rem,6vw,6.5rem)]">ТЕАТРАЛЬНАЯ, 18</h1><p className="mt-6 max-w-md text-base leading-7 text-ink">Центр Калуги, 4 минуты пешком от Театральной площади. Адрес демонстрационный.</p></div>
